...
public class WebEditor extends WebEditorGUIGeneric{
    ...
    private void setupGUI() {
        ...
        RegJButton addTitle = new RegJButton("Title");
        RegJButton addParagraph = new RegJButton("Paragraph");
        RegJButton addCode = new RegJButton("Code");
        RegJButton addFile = new RegJButton("File");
        RegJButton addImage = new RegJButton("Image");
        RegJButton addGallery = new RegJButton("Gallery");
        RegJButton addDivider = new RegJButton("Divider");
